-- ============================================
-- Script para agregar Telefono y Email a Vendedores
...
-- ============================================
-- Agregar campos Telefono y Email a Vendedores
-- ============================================
...
IF NOT EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID('Vendedores') AND name = 'Email')
BEGIN
    ALTER TABLE Vendedores
    ADD Email NVARCHAR(100) NULL;
    PRINT '✅ Campo Email agregado a la tabla Vendedores';
END
ELSE
BEGIN
    PRINT '⚠️  El campo Email ya existe en la tabla Vendedores';
END
GO

-- ============================================
-- Actualizar la vista VistaVendedores
-- IMPORTANTE: Esto debe ejecutarse DESPUÉS de agregar los campos
-- ============================================

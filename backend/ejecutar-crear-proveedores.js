// Script para ejecutar el SQL de creación de tabla Proveedores
...
async function ejecutarScript() {
  ...
  try {
    ...
    // Leer el archivo SQL
    const sqlPath = path.join(__dirname, '..', 'database', 'crear-tabla-proveedores.sql');
    ...
    console.log('');
    console.log('═══════════════════════════════════════════════════');
    console.log('✅ Script de Proveedores ejecutado exitosamente');
    console.log('═══════════════════════════════════════════════════');
  } catch (error) {
